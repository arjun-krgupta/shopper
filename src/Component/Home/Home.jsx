...
import mobile from "../Assets/Front icon/phones.png";
import laptop from "../Assets/Front icon/laptop.png";
import men from "../Assets/Front icon/man-removebg-preview.png";
import women from "../Assets/Front icon/women.png";

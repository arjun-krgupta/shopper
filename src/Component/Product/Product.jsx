     ...
     <div className="Product">
        ...
        <div className="mobile-area mt-3 mx-2 pb-3 ">
          ...
          <div className="flex justify-around overflow-x-scroll webkit w-full gap-2 px-2  py-2 sm:px-3">
              <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect("/realme")}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect("/vivo")}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/poco')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect("/oppo")}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/samsung')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44 " onClick={()=>{redirect("/iphone")}}>
        ...
        <div className="laptop-area mt-3 mx-2 pb-3">
          ...
          <div className="flex justify-around overflow-x-scroll webkit w-full gap-2 px-2 py-1 sm:px-3">
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/hp')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44"  onClick={()=>{redirect('/dell')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44"  onClick={()=>{redirect("/lenovo")}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44"  onClick={()=>{redirect('/asus')}}>
            ...
            <div className="flex flex-col gap-[10px] items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44"  onClick={()=>{redirect('/apple')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44"  onClick={()=>{redirect('/acer')}}>
        ...
        <div className="men-area mt-3 mx-2 pb-3 ">
          ...
          <div className="flex justify-around overflow-x-scroll webkit w-full gap-2 px-2 py-2 sm:px-3" >
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/hoodie')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/jeans')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/lower')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/pant')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/shirt')}}>
        ...
        <div className="women-area mt-3 mx-2 pb-3">
          ...
          <div className="flex justify-around overflow-x-scroll webkit w-full gap-2 px-2 py-2 sm:px-3">
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/lehenga')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/suit-salwar')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/one-piece')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/suit')}}>
            ...
            <div className="flex flex-col gap-2 items-center w-32 border border-gray-50 py-2 px-2 cursor-pointer hover:scale-[1.04] hover:transition rounded sm:w-36 md:w-44" onClick={()=>{redirect('/gown')}}>

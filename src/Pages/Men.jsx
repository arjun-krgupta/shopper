...
import allen_solly, { adidas, Cobb, highlander, mufti, peter_england } from '../Component/Product/All-men-data/All_data';
...
import highlander_icon from '../Component/Assets/men/icon/highlander.png'
    ...
    return (
        ...
        <div className='flex justify-center items-center gap-2 w-full mt-2'>
           ...
           <img src={peter_icon} alt="" className="max-w-full h-auto object-cover" />
            ...
            <div className="w-11 sm:w-16 md:w-20 cursor-pointer" onClick={()=>{redirect('/highlander')}}>
            <img src={highlander_icon} alt="" className="max-w-full h-auto object-cover" />
            </div>
        </div>
        ...
        <div className="flex justify-between items-center px-4">
          ...
          <hr className='w-full mt-1' />
        <div className="flex justify-between items-center px-4">
            <h4 className='font-bold text-xl my-[6px]' onClick={()=>{redirect('/mufti')}} >Mufti</h4>
          ...
          <hr className='w-full mt-1' />
        <div className="flex justify-between items-center px-4">
            <h4 className='font-bold text-xl my-[6px]' onClick={()=>{redirect('/cobb')}} >Cobb Italy</h4>
          ...
          <hr className='w-full mt-1' />
        <div className="flex justify-between items-center px-4">
            <h4 className='font-bold text-xl my-[6px]' onClick={()=>{redirect('/adidas')}} >Adidas</h4>
          ...
          <hr className='w-full mt-1' />
        <div className="flex justify-between items-center px-4">
            <h4 className='font-bold text-xl my-[6px]' onClick={()=>{redirect('/peter_england')}} >Peter England</h4>
          ...
          <hr className='w-full mt-1' />
        <div className="flex justify-between items-center px-4">
            <h4 className='font-bold text-xl my-[6px]' onClick={()=>{redirect('/highlander')}} >Highlander</h4>
            <Link to='/highlander' className=''>View all</Link>
            </div>
                {/* Highlander */}
            <hr className='w-full' />
            <div className="flex justify-around overflow-x-scroll webkit w-full my-[10px]">
            {highlander.map((val,i)=>
              <div className="flex flex-col items-center gap-2 w-36 sm:w-40 md:w-44 px-3 " key={i}>
                <img src={val.image} alt="" className='max-w-full h-auto' />
               <div className="flex flex-col items-center">
                <div className="text-sm text-gray-400">{val.brand}</div>

...
import { hoodie, jeans, lower, pant, shirt, t_shirt } from '../Component/Product/All-men-data/All_Nike';
...
function Nike(props) {
    ...
    return (
        ...
        <h1 className='text-4xl font-semibold my-3 text-center md:text-5xl'>Nike</h1>

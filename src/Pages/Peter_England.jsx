...
import { hoodie, jeans, lower, pant, shirt, t_shirt } from '../Component/Product/All-men-data/All_Peter_England';

function Peter_England(props) {
    ...
    return (
        ...
        <h1 className='text-4xl font-semibold my-3 text-center md:text-5xl'>Peter England</h1>

...
import lenovo_laptop from '../../Component/Product/All-laptop-data/Lenovo';
...
function Lenovo(props) {
    ...
    return (
       ...
       <div className='mt-3'>
            {
                lenovo_laptop.map((val,ind)=>
             <div className="flex justify-center gap-5 bg-white pt-2 pb-3 border-bottom mb-3 w-full cursor-pointer" key={ind}>

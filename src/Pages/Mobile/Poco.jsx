...
import Poco_product from '../../Component/Product/All-mobile-data/Poco'
    ...
    return (
        <>
         ...
         <div className='w-100 h-auto'>
            <h1 className='font-bold text-4xl mt-3 mb-1 text-center'>Poco Phones</h1>
              <img src={sl1} alt="" className='max-w-100 h-auto'/>
              <img src={sl2} alt="" className='max-w-100 h-auto'/>
         </div>
        <div className='mt-2'>
            {
                Poco_product.map((val,ind)=>

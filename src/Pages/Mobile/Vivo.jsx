...
import vivo_product from '../../Component/Product/All-mobile-data/Vivo';
       ...
       <>
        <div className='flex justify-center items-center gap-2 w-full mt-2'>
         ...
         <div className='w-100 h-auto'>
            <h1 className='font-bold text-4xl mt-3 mb-1 text-center'>Vivo Phones</h1>
              <img src={sl1} alt="" className='max-w-100 h-auto'/>
              <img src={sl2} alt="" className='max-w-100 h-auto'/>
         </div>
        <div className='mt-2'>
            {
                vivo_product.map((val,ind)=>
            ...
            <div className="flex flex-col items-center gap-[2px]">
                ...
                <span className="text-gray-600 line-through text-base">{val.old_price}</span>
                <span className='text-green-700 text-sm'>{val.offer}</span>
            </div> 
            </div>
                )
            }

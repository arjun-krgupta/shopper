...
import Iphone_product from '../../Component/Product/All-mobile-data/Iphone'
        ...
        <div className='mt-2'>
            {
             ...
             <div className="flex justify-center sm:gap-6 md:gap-10 lg:gap-14 bg-white pb-3 border-bottom mb-2 w-full cursor-pointer" key={ind}>

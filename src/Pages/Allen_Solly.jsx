...
import { hoodie, jeans, lower, pant, shirt, t_shirt } from '../Component/Product/All-men-data/All_Allen_Solly';

function Allen_Solly(props) {
    ...
    return (
        ...
        <h1 className='text-4xl font-semibold my-3 text-center md:text-5xl'>Allen Solly</h1>

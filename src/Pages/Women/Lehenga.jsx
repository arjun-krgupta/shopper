...
import lehenga_product from '../../Component/Product/All-women-data/Lehenga';
...
function Lehenga(props) {
  const redirect=useNavigate()
    return (
        <>
          {/* Women Clothes icon */}
          <div className='flex justify-center items-center gap-4 w-full mt-2'>
            <div className="w-11 hover:text-pink-700 sm:w-16 md:w-20 cursor-pointer sm:me-2 lg:me-7" onClick={()=>{redirect('/lehenga')}}>
            <img src={lehenga_icon} alt="" className="max-w-full h-auto object-cover rounded-[50px]" />
            <p className="text-sm text-center font-semibold">Lehenga</p>
            </div>
            <div className="w-11 hover:text-pink-700 sm:w-16 md:w-20 cursor-pointer sm:me-2 lg:me-7" onClick={()=>{redirect('/gown')}}>
            <img src={gown_icon} alt="" className="max-w-full h-auto object-cover rounded-[50px]" />
            <p className="text-sm text-center font-semibold">Gown</p>
            </div>
            <div className="w-11 hover:text-pink-700 sm:w-16 md:w-20 cursor-pointer sm:me-2 lg:me-7 " onClick={()=>{redirect('/one-piece')}}>
            <img src={onePiece_icon} alt="" className="max-w-full h-auto object-cover rounded-[50px]" />
            <p className="text-sm text-center font-semibold">One-Piece</p>
            </div>
            <div className="w-11 hover:text-pink-700 sm:w-16 md:w-20 cursor-pointer sm:me-2 lg:me-7" onClick={()=>{redirect('/suit-salwar')}}>
            <img src={suitSalwar_icon} alt="" className="max-w-full h-auto object-cover rounded-[50px]" />
            <p className="text-sm text-center font-semibold">Salwar Suit</p>
            </div>
           <div className="w-11 hover:text-pink-700 sm:w-16 md:w-20 cursor-pointer sm:me-2 lg:me-7" onClick={()=>{redirect('/suit')}}>
           <img src={suit_icon} alt="" className="max-w-full h-auto object-cover rounded-[50px]" />
           <p className="text-sm text-center font-semibold">Suit</p>
           </div>
        ...
        <div className="flex justify-center gap-4 flex-wrap overflow-x-scroll webkit w-full mt-4 mb-1 px-5">
            {lehenga_product.map((val,i)=>

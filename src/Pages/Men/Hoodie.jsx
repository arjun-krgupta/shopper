...
function Hoodie(props) {
  const redirect =useNavigate()
    return (
        ...
        <div className="flex justify-center gap-3 flex-wrap overflow-x-scroll webkit w-full mt-4 mb-2 px-5">
            {hoodie_product.map((val,i)=>
              <div className="flex flex-col items-center gap-2 my-2 w-36 sm:w-40 md:w-60" key={i}>
